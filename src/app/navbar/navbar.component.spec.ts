...
describe('NavbarComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [MatIconModule, MatToolbarModule, MatSidenavModule, BrowserAnimationsModule],
  ...
  it('scroll should scroll to element', () => {
    ...
    expect(scrollMock).toHaveBeenCalledOnceWith({behavior: 'smooth', block: 'start', inline: 'nearest'});
  });
