...
const ContractMock = {
  ...
  create: (name: string, ticker: string, totalSupply: number, settings: any) => {},
...
describe('ShitcoinFactoryService', () => {
  ...
  it('create should call factory', () => {
    ...
    expect(createMock).toHaveBeenCalledOnceWith('Test Coin', 'TEST', 100, { from: 'test-account' });
  });
  ...
  xit('getShitcoinName should work', async () => {
    const name = await service.getShitcoinName('0x51cC0d8C5aF1c0D7f1407E80D12DA8a4faad2131');
